...
rc = load_json("/Users/carwynmac/ai-cl/testing/results/rc_checks_results.json") or {}
...
trial_smoke = load_json("/Users/carwynmac/ai-cl/testing/results/trial_run_smoke_results.json") or {}
